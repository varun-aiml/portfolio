...
/*===== SWIPER CAROUSEL =====*/ 
// const mySwiper = new mySwiper('.testimonial_container', {
//     spaceBetween: 16,
//     loop: true,
//     grabCursor: true,
...
gsap.from('.home_greeting, .home_name, .home_profession, .home_button ,.home_social-icon' ,{opacity:0, duration:2, delay:1, y:25, ease:'expo.out',stagger:.2})
